...
* `cornet` works as a handler for [`fb55/htmlparser2`](https://github.com/fb55/CSSselect), which is probably the fastest HTML parser currently available for node. And it's much less strict than the `sax` module used by `trumpet`.
